...
/**
 * IntArrayList debe almacenar números en un array con una longitud de 10 por defecto. Cuando se llama al método add,
 * primero debes determinar si el array está lleno. Si lo está, crea un nuevo array que sea el 50% más grande,
 * mueve todos los elementos al nuevo array y agrega el nuevo elemento.
...
public class IntArrayList implements IntList {
    ...
    private void resizeArray(){
        sizeTotal = (int) (array.length * 1.5);
